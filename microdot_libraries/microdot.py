...
The ``microdot_libraries`` module defines a few classes that help implement HTTP-based
...
class Request:
    ...
    def __init__(self, app, client_addr, method, url, http_version, headers,
        ...
        #: :class:`MultiDict <microdot_libraries.MultiDict>` object.
        self.args = {}
    ...
    def form(self):
        ...
        :class:`MultiDict <microdot_libraries.MultiDict>` object, or ``None`` if the
        ...
        :func:`with_form_data <microdot_libraries.multipart.with_form_data>`
    ...
    def files(self):
        ...
        The :func:`with_form_data <microdot_libraries.multipart.with_form_data>`
...
class Response:
    ...
    def delete_cookie(self, cookie, **kwargs):
        ...
        :param kwargs: Any cookie options and flags supported by
                       :meth:`set_cookie() <microdot_libraries.Response.set_cookie>`.
...
class Microdot:
    ...
    Example::
        ...
        from microdot_libraries import Microdot
    ...
    def abort(status_code, reason=None):
        ...
        Example::
            ...
            from microdot_libraries import abort
